...
<h4 class="text-center text-info font-weight-bold m-4">PRODUK TERBARU</h4>
  ...
  <div class="card-body bg-light">
    ...
    <?php if($data_produk['stok_produk']!=0):?>
       <a href="beli.php?id=<?php echo $data_produk['id_produk'] ;?>" class="btn btn-danger">Beli</a>
       <a href="index.php?page=detail&id=<?php echo $data_produk['id_produk'] ;?>" class="btn btn-info">Detail</a>
       <?php else:?>
        <strong class="badge bagde-warning text-weight-bold">HABIS</strong>
        <?php endif?>
  </div>
</div>
<?php
